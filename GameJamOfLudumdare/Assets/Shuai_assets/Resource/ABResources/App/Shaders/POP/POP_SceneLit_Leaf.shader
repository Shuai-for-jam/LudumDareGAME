Shader "Universal Render Pipeline/POP/Scene/Scene Lit Leaf"
{
    Properties
    {
        ...
        _SSSScattering("SSS Scattering", Range(0, 0.4)) = 0.1
        _SSSPower("SSS Power", Range(1, 5)) = 1.0
        _SSSIntensity("SSS Intensity", Range(0, 5)) = 1.0
