Shader "Universal Render Pipeline/POP/SIM/Scene/Scene Lit Glass Zwrite"
{
    Properties
    {
        ...
        _RefractThickness("Refract Thickness", Range(0.01, 20)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 _RefractColor, _MatcapReflectColor, _MatcapRefractColor;
            CBUFFER_END
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                half4 finalCol = 0;
                finalCol.rgb = surfaceData.albedo + matcap.rgb;
                finalCol.a = saturate(surfaceData.alpha + matcap.a);
