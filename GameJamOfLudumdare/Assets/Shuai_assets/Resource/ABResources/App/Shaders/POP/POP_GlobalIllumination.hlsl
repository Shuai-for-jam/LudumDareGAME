    ...
    half3 normalWS, half3 viewDirectionWS)
{
   ...
   // half4 rgbm = texCUBElod(_EnvironmentTex, half4(mul(R,rotationMatrix), mip));
    ...
    half3 indirectDiffuse = bakedGI * _EnvAmbientIntensity;
   // return  half4(indirectDiffuse, 1);
    half3 indirectSpecular = GlossyEnvironmentReflection(reflectVector, positionWS, brdfData.perceptualRoughness, 1.0h) * _EnvReflectionIntensity;
