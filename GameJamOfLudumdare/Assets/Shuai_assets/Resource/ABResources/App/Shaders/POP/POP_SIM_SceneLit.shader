Shader "Universal Render Pipeline/POP/SIM/Scene/Scene Lit"
{
    Properties
    {
        ...
        [Space(18)]
        [KeywordEnum(OFF, ON)]_Use_Albedo("Use Albedo Emission", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Emission
            #pragma multi_compile _ _USE_ALBEDO_ON
            ...
            inline void InitializeStandardLitSurfaceData_SIM(float2 uv, out SurfaceData outSurfaceData, float3 worldPos)
            {
                ...
                outSurfaceData.albedo = albedoAlpha.rgb * _BaseColor.rgb + specGloss.a * _EmissionColor.rgb * albedoAlpha.rgb * _EmissionIntensity;
                ...
                half f_smoothness = (_SmoothnessRemappingLevelHigh - _SmoothnessRemappingLevelLow) / (
                    _SmoothnessRemappingHigh - _SmoothnessRemappingLow);
                half f_metallic = (_MetallicRemappingLevelHigh - _MetallicRemappingLevelLow) / (_MetallicRemappingHigh -
                    _MetallicRemappingLow);
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                clip(_Transparency - thresholdMatrix[fmod(pos.x, 4)][fmod(pos.y, 4)]);
