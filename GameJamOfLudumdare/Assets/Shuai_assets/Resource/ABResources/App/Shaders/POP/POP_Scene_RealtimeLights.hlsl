...
#ifndef UNIVERSAL_POP_SCENE_REALTIME_LIGHTS_INCLUDED
#define UNIVERSAL_POP_SCENE_REALTIME_LIGHTS_INCLUDED
...
Light GetMainLight(InputData inputData, half4 shadowMask, POPAmbientOcclusionFactor aoFactor)
{
...
Light GetAdditionalLight(uint i, InputData inputData, half4 shadowMask, POPAmbientOcclusionFactor aoFactor)
{
