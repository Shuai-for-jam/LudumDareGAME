Shader "Universal Render Pipeline/POP/SIM/Scene/Scene Lit AlphaTest"
{
    Properties
    {
...
//        [HideInInspector][NoScaleOffset]unity_ShadowMasks("unity_ShadowMasks", 2DArray) = "" {}
    ...
    SubShader
    {
        ...
        Tags{"Queue"="AlphaTest" "RenderType" = "TransparentCutout" "RenderPipeline" = "UniversalPipeline" "UniversalMaterialType" = "Lit" "IgnoreProjector" = "True" "ShaderModel"="3.0"}
        LOD 300
